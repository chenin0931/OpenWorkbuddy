    ...
    <SubmitForm className="run-composer" onSubmit={() => {
      ...
      <div className="run-composer-bottom">
        <span>
          ...
          <span className="composer-context"><Icon name="lock" size={13} />{draftAccessMode === 'full_disk' ? '全盘自动' : '本机处理'}</span>
        </span>
