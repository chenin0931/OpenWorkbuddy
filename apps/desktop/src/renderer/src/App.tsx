...
function TasksView({
  ...
  if (!detail) return <main className="main-pane"><WelcomeComposer workspace={selectedWorkspace} models={snapshot.models} defaultMode={snapshot.settings.defaultExecutionMode === 'plan' ? 'plan' : 'execute'} onSubmit={onCreate} onOpenSettings={onSettings} /></main>
